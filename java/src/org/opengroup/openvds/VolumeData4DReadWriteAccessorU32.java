 ...
 * 
 */
public class VolumeData4DReadWriteAccessorU32 extends VolumeData4DReadAccessorU32 {
    ...
    public void setValue(IntVector4 index, int value) {
    ...
    public VolumeData4DReadWriteAccessorU32() {
    
        super(ctorImpl());
    
    }

    VolumeData4DReadWriteAccessorU32(long nativeobject) {
        super(nativeobject);
    }
