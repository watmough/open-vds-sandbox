 ...
 * 
 */
public class VolumeData4DReadWriteAccessorR32 extends VolumeData4DReadAccessorR32 {
    ...
    public void setValue(IntVector4 index, float value) {
    ...
    public VolumeData4DReadWriteAccessorR32() {
    
        super(ctorImpl());
    
    }

    VolumeData4DReadWriteAccessorR32(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData4DReadWriteAccessorR32 fromNativeObject(long nativeobject) {
        return new VolumeData4DReadWriteAccessorR32(nativeobject);
    }
