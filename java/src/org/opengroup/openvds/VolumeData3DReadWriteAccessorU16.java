 ...
 * 
 */
public class VolumeData3DReadWriteAccessorU16 extends VolumeData3DReadAccessorU16 {
    ...
    public VolumeData3DReadWriteAccessorU16() {
    
        super(ctorImpl());
    
    }

    VolumeData3DReadWriteAccessorU16(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData3DReadWriteAccessorU16 fromNativeObject(long nativeobject) {
        if (nativeobject == 0) {
           return null;
        }
        return new VolumeData3DReadWriteAccessorU16(nativeobject);
    }
