 ...
 * 
 */
public class VolumeData2DReadWriteAccessorU64 extends VolumeData2DReadAccessorU64 {
    ...
    public void setValue(IntVector2 index, long value) {
    ...
    public VolumeData2DReadWriteAccessorU64() {
    
        super(ctorImpl());
    
    }

    VolumeData2DReadWriteAccessorU64(long nativeobject) {
        super(nativeobject);
    }
