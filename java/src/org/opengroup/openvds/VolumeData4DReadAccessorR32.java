 ...
 * 
 */
public class VolumeData4DReadAccessorR32 extends ManagedBase implements AutoCloseable {
    ...
    public float getValue(IntVector4 index) {
    ...
    public VolumeData4DReadAccessorR32() {
    ...
    static VolumeData4DReadAccessorR32 fromNativeObject(long nativeobject) {
        return new VolumeData4DReadAccessorR32(nativeobject);
    }
