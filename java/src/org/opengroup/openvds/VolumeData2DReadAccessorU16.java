 ...
 * 
 */
public class VolumeData2DReadAccessorU16 extends ManagedBase implements AutoCloseable {
    ...
    public short getValue(IntVector2 index) {
    ...
    public VolumeData2DReadAccessorU16() {
    
        super(ctorImpl());
    
    }

    VolumeData2DReadAccessorU16(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData2DReadAccessorU16 fromNativeObject(long nativeobject) {
        return new VolumeData2DReadAccessorU16(nativeobject);
    }
