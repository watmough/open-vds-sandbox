 ...
 * 
 */
public class VolumeData2DReadWriteAccessorU8 extends VolumeData2DReadAccessorU8 {
    ...
    public void setValue(IntVector2 index, byte value) {
    ...
    public VolumeData2DReadWriteAccessorU8() {
    ...
    static VolumeData2DReadWriteAccessorU8 fromNativeObject(long nativeobject) {
        return new VolumeData2DReadWriteAccessorU8(nativeobject);
    }
