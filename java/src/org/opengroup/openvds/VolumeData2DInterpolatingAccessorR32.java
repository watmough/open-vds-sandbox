 ...
 * 
 */
public class VolumeData2DInterpolatingAccessorR32 extends ManagedBase implements AutoCloseable {
    ...
    public IndexRegionFloatVector2 region(long region) {
        return IndexRegionFloatVector2.fromNativeObject(RegionImpl(getNativeObject(), region));
    }
    ...
    public long regionFromIndex(FloatVector2 index) {
    ...
    public IndexRegionFloatVector2 currentRegion() {
        return IndexRegionFloatVector2.fromNativeObject(CurrentRegionImpl(getNativeObject()));
    }
    ...
    public float getValue(FloatVector2 index) {
    ...
    public VolumeData2DInterpolatingAccessorR32() {
    
        super(ctorImpl());
    
    }

    VolumeData2DInterpolatingAccessorR32(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData2DInterpolatingAccessorR32 fromNativeObject(long nativeobject) {
        return new VolumeData2DInterpolatingAccessorR32(nativeobject);
    }
