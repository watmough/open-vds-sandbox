 ...
 * 
 */
public class VolumeData4DReadAccessorR64 extends ManagedBase implements AutoCloseable {
    ...
    public double getValue(IntVector4 index) {
    ...
    public VolumeData4DReadAccessorR64() {
    
        super(ctorImpl());
    
    }

    VolumeData4DReadAccessorR64(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData4DReadAccessorR64 fromNativeObject(long nativeobject) {
        return new VolumeData4DReadAccessorR64(nativeobject);
    }
