 ...
 * 
 */
public class VolumeData3DReadWriteAccessorU32 extends VolumeData3DReadAccessorU32 {
    ...
    public void setValue(IntVector3 index, int value) {
    ...
    public VolumeData3DReadWriteAccessorU32() {
    
        super(ctorImpl());
    
    }

    VolumeData3DReadWriteAccessorU32(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData3DReadWriteAccessorU32 fromNativeObject(long nativeobject) {
        if (nativeobject == 0) {
           return null;
        }
        return new VolumeData3DReadWriteAccessorU32(nativeobject);
    }
