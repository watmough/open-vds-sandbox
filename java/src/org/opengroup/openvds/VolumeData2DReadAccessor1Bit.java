 ...
 * 
 */
public class VolumeData2DReadAccessor1Bit extends ManagedBase implements AutoCloseable {
    ...
    public VolumeData2DReadAccessor1Bit() {
    
        super(ctorImpl());
    
    }

    VolumeData2DReadAccessor1Bit(long nativeobject) {
        super(nativeobject);
    }
