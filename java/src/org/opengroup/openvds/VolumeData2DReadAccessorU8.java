 ...
 * 
 */
public class VolumeData2DReadAccessorU8 extends ManagedBase implements AutoCloseable {
    ...
    public byte getValue(IntVector2 index) {
    ...
    public VolumeData2DReadAccessorU8() {
    
        super(ctorImpl());
    
    }

    VolumeData2DReadAccessorU8(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData2DReadAccessorU8 fromNativeObject(long nativeobject) {
        return new VolumeData2DReadAccessorU8(nativeobject);
    }
