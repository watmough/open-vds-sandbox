...
public class VolumeData2DReadWriteAccessorR32 extends VolumeData2DReadAccessorR32 {
    ...
    public VolumeData2DReadWriteAccessorR32() {
    
        super(ctorImpl());
    
    }

    VolumeData2DReadWriteAccessorR32(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData2DReadWriteAccessorR32 fromNativeObject(long nativeobject) {
        return new VolumeData2DReadWriteAccessorR32(nativeobject);
    }
