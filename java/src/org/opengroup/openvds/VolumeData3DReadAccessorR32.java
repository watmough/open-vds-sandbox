 ...
 * 
 */
public class VolumeData3DReadAccessorR32 extends ManagedBase implements AutoCloseable {
    ...
    public float getValue(IntVector3 index) {
    ...
    public VolumeData3DReadAccessorR32() {
    
        super(ctorImpl());
    
    }

    VolumeData3DReadAccessorR32(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData3DReadAccessorR32 fromNativeObject(long nativeobject) {
        return new VolumeData3DReadAccessorR32(nativeobject);
    }
