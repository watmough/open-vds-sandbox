 ...
 * 
 */
public class VolumeData2DReadAccessorU64 extends ManagedBase implements AutoCloseable {
    ...
    public long getValue(IntVector2 index) {
    ...
    public VolumeData2DReadAccessorU64() {
    
        super(ctorImpl());
    
    }

    VolumeData2DReadAccessorU64(long nativeobject) {
        super(nativeobject);
    }
