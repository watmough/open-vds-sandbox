 ...
 * 
 */
public class VolumeData3DReadAccessor1Bit extends ManagedBase implements AutoCloseable {
    ...
    public boolean getValue(IntVector3 index) {
    ...
    public VolumeData3DReadAccessor1Bit() {
    ...
    static VolumeData3DReadAccessor1Bit fromNativeObject(long nativeobject) {
        ...
        return new VolumeData3DReadAccessor1Bit(nativeobject);
    }
