 ...
 * 
 */
public class VolumeData4DReadWriteAccessorU8 extends VolumeData4DReadAccessorU8 {
    ...
    public void setValue(IntVector4 index, byte value) {
    ...
    public VolumeData4DReadWriteAccessorU8() {
    
        super(ctorImpl());
    
    }

    VolumeData4DReadWriteAccessorU8(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData4DReadWriteAccessorU8 fromNativeObject(long nativeobject) {
        return new VolumeData4DReadWriteAccessorU8(nativeobject);
    }
