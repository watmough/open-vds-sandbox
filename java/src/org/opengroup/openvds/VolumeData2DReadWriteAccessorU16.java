 ...
 * 
 */
public class VolumeData2DReadWriteAccessorU16 extends VolumeData2DReadAccessorU16 {
    ...
    public void setValue(IntVector2 index, short value) {
    ...
    public VolumeData2DReadWriteAccessorU16() {
    
        super(ctorImpl());
    
    }

    VolumeData2DReadWriteAccessorU16(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData2DReadWriteAccessorU16 fromNativeObject(long nativeobject) {
        return new VolumeData2DReadWriteAccessorU16(nativeobject);
    }
