 ...
 * 
 */
public class VolumeData4DInterpolatingAccessorR32 extends ManagedBase implements AutoCloseable {
    ...
    public VolumeData4DInterpolatingAccessorR32() {
    
        super(ctorImpl());
    
    }

    VolumeData4DInterpolatingAccessorR32(long nativeobject) {
        super(nativeobject);
    }
