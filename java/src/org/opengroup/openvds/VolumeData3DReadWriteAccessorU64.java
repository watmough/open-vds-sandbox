 ...
 * 
 */
public class VolumeData3DReadWriteAccessorU64 extends VolumeData3DReadAccessorU64 {
    ...
    public void setValue(IntVector3 index, long value) {
    ...
    public VolumeData3DReadWriteAccessorU64() {
    
        super(ctorImpl());
    
    }

    VolumeData3DReadWriteAccessorU64(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData3DReadWriteAccessorU64 fromNativeObject(long nativeobject) {
        return new VolumeData3DReadWriteAccessorU64(nativeobject);
    }
