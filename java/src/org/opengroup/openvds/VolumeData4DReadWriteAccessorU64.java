 ...
 * 
 */
public class VolumeData4DReadWriteAccessorU64 extends VolumeData4DReadAccessorU64 {
    ...
    public VolumeData4DReadWriteAccessorU64() {
    
        super(ctorImpl());
    
    }

    VolumeData4DReadWriteAccessorU64(long nativeobject) {
        super(nativeobject);
    }
