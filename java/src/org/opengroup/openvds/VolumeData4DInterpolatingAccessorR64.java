 ...
 * 
 */
public class VolumeData4DInterpolatingAccessorR64 extends ManagedBase implements AutoCloseable {
    ...
    public IndexRegionFloatVector4 region(long region) {
        return IndexRegionFloatVector4.fromNativeObject(RegionImpl(getNativeObject(), region));
    }
    ...
    public long regionFromIndex(FloatVector4 index) {
    ...
    public IndexRegionFloatVector4 currentRegion() {
    ...
    public double getValue(FloatVector4 index) {
    ...
    public VolumeData4DInterpolatingAccessorR64() {
    
        super(ctorImpl());
    
    }

    VolumeData4DInterpolatingAccessorR64(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData4DInterpolatingAccessorR64 fromNativeObject(long nativeobject) {
        return new VolumeData4DInterpolatingAccessorR64(nativeobject);
    }
