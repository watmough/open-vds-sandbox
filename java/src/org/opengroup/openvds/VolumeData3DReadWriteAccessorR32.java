 ...
 * 
 */
public class VolumeData3DReadWriteAccessorR32 extends VolumeData3DReadAccessorR32 {
    ...
    public void setValue(IntVector3 index, float value) {
    ...
    public VolumeData3DReadWriteAccessorR32() {
    
        super(ctorImpl());
    
    }

    VolumeData3DReadWriteAccessorR32(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData3DReadWriteAccessorR32 fromNativeObject(long nativeobject) {
        return new VolumeData3DReadWriteAccessorR32(nativeobject);
    }
