...
JNIEXPORT jlong JNICALL Java_com_hue_proxylib_MetadataKey_ctor2Impl
  (JNIEnv * env, jclass cls, jobject jproxyinterface, jint type, jstring category, jstring name)
{
  JEnvPushPop
    stackitem(env, jproxyinterface);
...
JNIEXPORT jint JNICALL Java_com_hue_proxylib_MetadataKey_GetTypeImpl
