 ...
 * 
 */
public class VolumeData4DReadWriteAccessorR64 extends VolumeData4DReadAccessorR64 {
    ...
    public void setValue(IntVector4 index, double value) {
    ...
    public VolumeData4DReadWriteAccessorR64() {
    
        super(ctorImpl());
    
    }

    VolumeData4DReadWriteAccessorR64(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData4DReadWriteAccessorR64 fromNativeObject(long nativeobject) {
        if (nativeobject == 0) {
           return null;
        }
        return new VolumeData4DReadWriteAccessorR64(nativeobject);
    }
