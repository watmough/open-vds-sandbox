 ...
 * 
 */
public class VolumeData4DReadAccessorU64 extends ManagedBase implements AutoCloseable {
    ...
    public long getValue(IntVector4 index) {
    ...
    public VolumeData4DReadAccessorU64() {
    
        super(ctorImpl());
    
    }

    VolumeData4DReadAccessorU64(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData4DReadAccessorU64 fromNativeObject(long nativeobject) {
        if (nativeobject == 0) {
           return null;
        }
        return new VolumeData4DReadAccessorU64(nativeobject);
    }
