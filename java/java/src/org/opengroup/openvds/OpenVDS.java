...
Available schemes are s3:// azure://
    ...
    ///AUTOGEN-OK: FUNCTION_DECL Open OpenVDS::VDS *(OpenVDS::IOManager *, OpenVDS::LogLevel, OpenVDS::VDSError &) FUNCTIONPROTO
    native private static long Open5Impl(long ioManager, long logLevel, long error);
     ...
     * @return The VDS handle that can be used to get the VolumeDataLayout and the VolumeDataAccessManager
     */
    public static VDS open(IOManager ioManager, LogLevel logLevel, VDSError error) {
        return VDS.fromNativeObject(Open5Impl(ManagedBase.requireNonNull(ioManager, "ioManager may not be null").getNativeObject(), ManagedBase.requireNonNull(logLevel, "logLevel may not be null").value(), ManagedBase.requireNonNull(error, "error may not be null").getNativeObject()));
    }
    public static VDS open(IOManager ioManager, LogLevel logLevel) throws java.io.IOException {
        VDSError error = new VDSError();
        VDS result = open(ioManager, logLevel, error);
        if (error.getCode() != 0) {
            throw new java.io.IOException(error.getString());
        }
        return result;
...
Available schemes are s3:// azure://
    ...
    ///AUTOGEN-OK: FUNCTION_DECL Create OpenVDS::VDS *(OpenVDS::IOManager *, const OpenVDS::VolumeDataLayoutDescriptor &, std::vector<OpenVDS::VolumeDataAxisDescriptor>, std::vector<OpenVDS::VolumeDataChannelDescriptor>, const OpenVDS::MetadataReadAccess &, OpenVDS::CompressionMethod, float, OpenVDS::LogLevel, OpenVDS::VDSError &) FUNCTIONPROTO
    native private static long Create8Impl(long ioManager, long layoutDescriptor, long[] axisDescriptors, long[] channelDescriptors, long metadata, long compressionMethod, float compressionTolerance, long logLevel, long error);
     ...
     * @return The VDS handle that can be used to get the VolumeDataLayout and the VolumeDataAccessManager
     */
    public static VDS create(IOManager ioManager, VolumeDataLayoutDescriptor layoutDescriptor, VolumeDataAxisDescriptor[] axisDescriptors, VolumeDataChannelDescriptor[] channelDescriptors, MetadataReadAccess metadata, CompressionMethod compressionMethod, float compressionTolerance, LogLevel logLevel, VDSError error) {
        long[] axisDescriptorstmp = new long[ManagedBase.requireNonNull(axisDescriptors, "axisDescriptors may not be null").length];
        for (int i = 0; i < axisDescriptors.length; ++i) {
            axisDescriptorstmp[i] = axisDescriptors[i].getNativeObject();
        }
        ...
        return VDS.fromNativeObject(Create8Impl(ManagedBase.requireNonNull(ioManager, "ioManager may not be null").getNativeObject(), ManagedBase.requireNonNull(layoutDescriptor, "layoutDescriptor may not be null").getNativeObject(), axisDescriptorstmp, channelDescriptorstmp, ManagedBase.requireNonNull(metadata, "metadata may not be null").getNativeObject(), ManagedBase.requireNonNull(compressionMethod, "compressionMethod may not be null").value(), compressionTolerance, ManagedBase.requireNonNull(logLevel, "logLevel may not be null").value(), ManagedBase.requireNonNull(error, "error may not be null").getNativeObject()));
    }
    public static VDS create(IOManager ioManager, VolumeDataLayoutDescriptor layoutDescriptor, VolumeDataAxisDescriptor[] axisDescriptors, VolumeDataChannelDescriptor[] channelDescriptors, MetadataReadAccess metadata, CompressionMethod compressionMethod, float compressionTolerance, LogLevel logLevel) throws java.io.IOException {
        VDSError error = new VDSError();
        VDS result = create(ioManager, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, compressionMethod, compressionTolerance, logLevel, error);
        if (error.getCode() != 0) {
            throw new java.io.IOException(error.getString());
        }
        return result;
    ...
    native private static long Create9Impl(long ioManager, long layoutDescriptor, long[] axisDescriptors, long[] channelDescriptors, long metadata, long error);
    ...
    public static VDS create(IOManager ioManager, VolumeDataLayoutDescriptor layoutDescriptor, VolumeDataAxisDescriptor[] axisDescriptors, VolumeDataChannelDescriptor[] channelDescriptors, MetadataReadAccess metadata, VDSError error) {
        ...
        return VDS.fromNativeObject(Create9Impl(ManagedBase.requireNonNull(ioManager, "ioManager may not be null").getNativeObject(), ManagedBase.requireNonNull(layoutDescriptor, "layoutDescriptor may not be null").getNativeObject(), axisDescriptorstmp, channelDescriptorstmp, ManagedBase.requireNonNull(metadata, "metadata may not be null").getNativeObject(), ManagedBase.requireNonNull(error, "error may not be null").getNativeObject()));
    }
    ...
    ///AUTOGEN-OK: FUNCTION_DECL Create OpenVDS::VDS *(OpenVDS::IOManager *, const OpenVDS::VolumeDataLayoutDescriptor &, std::vector<OpenVDS::VolumeDataAxisDescriptor>, std::vector<OpenVDS::VolumeDataChannelDescriptor>, const OpenVDS::MetadataReadAccess &, OpenVDS::LogLevel, OpenVDS::VDSError &) FUNCTIONPROTO
    native private static long Create10Impl(long ioManager, long layoutDescriptor, long[] axisDescriptors, long[] channelDescriptors, long metadata, long logLevel, long error);
     ...
     * @return The VDS handle that can be used to get the VolumeDataLayout and the VolumeDataAccessManager
     */
    public static VDS create(IOManager ioManager, VolumeDataLayoutDescriptor layoutDescriptor, VolumeDataAxisDescriptor[] axisDescriptors, VolumeDataChannelDescriptor[] channelDescriptors, MetadataReadAccess metadata, LogLevel logLevel, VDSError error) {
        long[] axisDescriptorstmp = new long[ManagedBase.requireNonNull(axisDescriptors, "axisDescriptors may not be null").length];
        for (int i = 0; i < axisDescriptors.length; ++i) {
            axisDescriptorstmp[i] = axisDescriptors[i].getNativeObject();
        }
        ...
        return VDS.fromNativeObject(Create10Impl(ManagedBase.requireNonNull(ioManager, "ioManager may not be null").getNativeObject(), ManagedBase.requireNonNull(layoutDescriptor, "layoutDescriptor may not be null").getNativeObject(), axisDescriptorstmp, channelDescriptorstmp, ManagedBase.requireNonNull(metadata, "metadata may not be null").getNativeObject(), ManagedBase.requireNonNull(logLevel, "logLevel may not be null").value(), ManagedBase.requireNonNull(error, "error may not be null").getNativeObject()));
    }
    public static VDS create(IOManager ioManager, VolumeDataLayoutDescriptor layoutDescriptor, VolumeDataAxisDescriptor[] axisDescriptors, VolumeDataChannelDescriptor[] channelDescriptors, MetadataReadAccess metadata, LogLevel logLevel) throws java.io.IOException {
        VDSError error = new VDSError();
        VDS result = create(ioManager, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, logLevel, error);
        if (error.getCode() != 0) {
            throw new java.io.IOException(error.getString());
        }
        return result;
