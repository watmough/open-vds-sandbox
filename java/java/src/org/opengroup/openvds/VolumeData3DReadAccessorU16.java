 ...
 * 
 */
public class VolumeData3DReadAccessorU16 extends ManagedBase implements AutoCloseable {
    ...
    public short getValue(IntVector3 index) {
    ...
    public VolumeData3DReadAccessorU16() {
    
        super(ctorImpl());
    
    }

    VolumeData3DReadAccessorU16(long nativeobject) {
        super(nativeobject);
    }
    ...
    static VolumeData3DReadAccessorU16 fromNativeObject(long nativeobject) {
        if (nativeobject == 0) {
           return null;
        }
        return new VolumeData3DReadAccessorU16(nativeobject);
    }
