 ...
 * 
 */
public class VolumeData2DInterpolatingAccessorR64 extends ManagedBase implements AutoCloseable {
    ...
    public double getValue(FloatVector2 index) {
    ...
    public VolumeData2DInterpolatingAccessorR64() {
    
        super(ctorImpl());
    
    }

    VolumeData2DInterpolatingAccessorR64(long nativeobject) {
        super(nativeobject);
    }
