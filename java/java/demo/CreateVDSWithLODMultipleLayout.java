...
public class CreateVDSWithLODMultipleLayout {
    ...
    public static void main(String[] args) {
        try {
            if (!checkParams(args)) {
                System.out.println("Bad params, usage  : <CreateVDSWithLODMultipleLayout> n /path/to/file");
    ...
    static void process(int lodParam, String vdsFilePath) throws Exception {
        ...
        DimensionsND[] layouts = new DimensionsND[] {DimensionsND.DIMENSIONS_012, DimensionsND.DIMENSIONS_01};
        ...
        VDSFileOpenOptions optionsFile = new VDSFileOpenOptions(vdsFilePath);

//        String pBucket = "miniovaap"; // the bucket of the VDS
//        String pKey = "CubeTestMultipleLayout_Cloud.vds"; // the key prefix of the VDS ?
...
//        optionsAWS.accessKeyId = "minioadmin"; // ?
//        optionsAWS.secretKey = "minioadmin";
//        optionsAWS.sessionToken = ""; // ?
        VdsError error;

        MetadataContainer metadataContainer = new MetadataContainer();
        metadataContainer.setMetadataString("Test", "String", "Test 2 layouts");
        metadataContainer.setMetadataString("Test", "Data Info", "300x300x200 Brick32 + 2D");
        //metadataContainer.SetMetadataBLOB("categoryBLOB", "BLOB", data, 4 );

        OpenVDS vds = OpenVDS.create(optionsFile, layoutDescriptor,
        ...
        for (DimensionsND layoutDim : layouts) {
            ...
            for (int lod = 0; lod <= lodCount; ++lod) {
                VolumeDataPageAccessor pageAccessor = accessManager.createVolumeDataPageAccessor(
                        layout, // layout
                        layoutDim.ordinal(), // dimension ND
                        lod, // lod
                        channel, // channel
                        100, // max pages
                ...
                for (int i = 0; i < chunkCount; i++) {
                    ...
                    VolumeIndexer3D outputIndexer = new VolumeIndexer3D(page, 0, lod, layoutDim.ordinal(), layout);
                ...
                // TODO check if errors : must call or not some methods?
