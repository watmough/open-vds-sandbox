...
TEST(IOTests, performance)
{
  ...
  OpenVDS::Error error;
  OpenVDS::IOManager* ioManager = OpenVDS::IOManager::CreateIOManager(url, connectionString, OpenVDS::IOManager::AccessPattern::ReadWrite, OpenVDS::CreateDefaultLogHandler(), error);
