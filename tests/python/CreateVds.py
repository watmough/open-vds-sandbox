...
def CreateVds(name, size = (100, 100, 100), format = openvds.VolumeDataChannelDescriptor.Format.Format_R32, brickSize = openvds.VolumeDataLayoutDescriptor.BrickSize.BrickSize_64,):
    if CreateVds.initialized.get(name, False):
        return
    CreateVds.initialized[name] = True
