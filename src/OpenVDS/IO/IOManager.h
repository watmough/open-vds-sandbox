...
namespace OpenVDS
{
  ...
  public:
    ...
    OPENVDS_EXPORT
    static IOManager *CreateIOManager(const OpenOptions &options, IOManager::AccessPattern accessPattern, OpenVDSLogging logHandler, Error &error);

    OPENVDS_EXPORT
      static IOManager* CreateIOManager(const StringWrapper& url, const StringWrapper& connectionString, IOManager::AccessPattern accessPattern, OpenVDSLogging logHandler, Error& error);
