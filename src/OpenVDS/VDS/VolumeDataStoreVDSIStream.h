...
#ifndef VOLUMEDATASTOREVDSISTREAM_H
#define VOLUMEDATASTOREVDSISTREAM_H
...
class VolumeDataStoreVDSIStream : public VolumeDataStoreVDSFile
{
  // struct LayerFile
  // {
...
public:
  ...
  VolumeDataStoreVDSIStream(VDS &vds, const void *vdsIStream, Mode mode, Error &error);
 ~VolumeDataStoreVDSIStream();
};

}

#endif //VOLUMEDATASTOREVDSISTREAM_H
