...
RUN yum install -y python3 python3-devel gcc boost-devel git doxygen java-1.8.0-openjdk-devel libxml2-devel zlib-devel openssl-devel libcurl-devel libuv libuuid-devel
