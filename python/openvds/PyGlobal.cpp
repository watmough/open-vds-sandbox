...
//AUTOGEN-BEGIN
  ...
  m.def("open"                        , static_cast<native::VDSHandle(*)(native::IOManager *, native::LogLevel, const native::LogHandler &, native::Error &)>(&Open), py::arg("ioManager").none(false), py::arg("logLevel").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_8));
  m.def("open"                        , [](OpenVDS::IOManager * ioManager, OpenVDS::LogLevel logLevel, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Open(ioManager, logLevel, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("ioManager").none(false), py::arg("logLevel").none(false), py::arg("logHandler").none(false));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(native::IOManager *, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::CompressionMethod, float, native::LogLevel, const native::LogHandler &, native::Error &)>(&Create), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logLevel").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_14));
  m.def("create"                      , [](OpenVDS::IOManager * ioManager, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, OpenVDS::CompressionMethod compressionMethod, float compressionTolerance, OpenVDS::LogLevel logLevel, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(ioManager, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, compressionMethod, compressionTolerance, logLevel, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logLevel").none(false), py::arg("logHandler").none(false));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(native::IOManager *, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::LogLevel, const native::LogHandler &, native::Error &)>(&Create), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logLevel").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_16));
  m.def("create"                      , [](OpenVDS::IOManager * ioManager, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, OpenVDS::LogLevel logLevel, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(ioManager, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, logLevel, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logLevel").none(false), py::arg("logHandler").none(false));
