...
// IMPLEMENTED : DMSOpenOptions_.def(py::init<const std::string &, const std::string &, const std::string &, std::string (*)(const void *), const void *, bool, const std::string &, const std::string &>(), py::arg("sdAuthorityUrl").none(false), py::arg("sdApiKey").none(false), py::arg("datasetPath").none(false), py::arg("authProviderCallback").none(false), py::arg("authProviderCallbackData").none(false), py::arg("useFileNameForSingleFileDatasets") = false, py::arg("legalTag").none(false), py::arg("httpProxy").none(false), OPENVDS_DOCSTRING(DMSOpenOptions_DMSOpenOptions_3));
