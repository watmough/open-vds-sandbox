...
//AUTOGEN-BEGIN
  ...
  // LogHandler
  py::class_<LogHandler> 
    LogHandler_(m,"LogHandler", OPENVDS_DOCSTRING(LogHandler));

  LogHandler_.def(py::init<                              >(), OPENVDS_DOCSTRING(LogHandler_LogHandler));
  LogHandler_.def(py::init<native::LogLevel, native::LogHandler::LogCallback, void *>(), py::arg("level").none(false), py::arg("callback").none(false), py::arg("userHandle").none(false), OPENVDS_DOCSTRING(LogHandler_LogHandler_2));
  LogHandler_.def_readwrite("level"                       , &LogHandler::level             , OPENVDS_DOCSTRING(LogHandler_level));
  LogHandler_.def_readwrite("callback"                    , &LogHandler::callback          , OPENVDS_DOCSTRING(LogHandler_callback));
  LogHandler_.def_readwrite("userHandle"                  , &LogHandler::userHandle        , OPENVDS_DOCSTRING(LogHandler_userHandle));
  ...
  OpenOptions_.def_readwrite("logLevelIsSet"               , &OpenOptions::logLevelIsSet    , OPENVDS_DOCSTRING(OpenOptions_logLevelIsSet));
  ...
  DMSOpenOptions_.def(py::init<const std::string &, const std::string &, const std::string &, const std::string &, const std::string &, const std::string &, const std::string &, const std::string &, const std::string &, bool>(), py::arg("sdAuthorityUrl").none(false), py::arg("sdApiKey").none(false), py::arg("sdToken").none(false), py::arg("datasetPath").none(false), py::arg("authTokenUrl").none(false), py::arg("refreshToken").none(false), py::arg("clientId").none(false), py::arg("clientSecret").none(false), py::arg("scopes").none(false), py::arg("useFileNameForSingleFileDatasets") = false, OPENVDS_DOCSTRING(DMSOpenOptions_DMSOpenOptions_2));
  DMSOpenOptions_.def(py::init<const std::string &, const std::string &, const std::string &, std::string (*)(const void *), const void *, bool>(), py::arg("sdAuthorityUrl").none(false), py::arg("sdApiKey").none(false), py::arg("datasetPath").none(false), py::arg("authProviderCallback").none(false), py::arg("authProviderCallbackData").none(false), py::arg("useFileNameForSingleFileDatasets") = false, OPENVDS_DOCSTRING(DMSOpenOptions_DMSOpenOptions_3));
  ...
  m.def("createDefaultLogHandler"     , static_cast<native::LogHandler(*)()>(&CreateDefaultLogHandler), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(CreateDefaultLogHandler));
  ...
  m.def("createOpenOptions"           , static_cast<native::OpenOptions *(*)(std::string, std::string, const native::LogHandler &, native::Error &)>(&CreateOpenOptions), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(CreateOpenOptions_2));
  m.def("createOpenOptions"           , [](std::string url, std::string connectionString, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = CreateOpenOptions(url, connectionString, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("logHandler").none(false));
  ...
  m.def("open"                        , static_cast<native::VDSHandle(*)(std::string, std::string, const native::LogHandler &, native::Error &)>(&Open), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_2));
  m.def("open"                        , [](std::string url, std::string connectionString, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Open(url, connectionString, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("logHandler").none(false));
  ...
  m.def("openWithAdaptiveCompressionTolerance", static_cast<native::VDSHandle(*)(std::string, std::string, float, const native::LogHandler &, native::Error &)>(&OpenWithAdaptiveCompressionTolerance), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("waveletAdaptiveTolerance").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(OpenWithAdaptiveCompressionTolerance_2));
  m.def("openWithAdaptiveCompressionTolerance", [](std::string url, std::string connectionString, float waveletAdaptiveTolerance, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = OpenWithAdaptiveCompressionTolerance(url, connectionString, waveletAdaptiveTolerance, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("waveletAdaptiveTolerance").none(false), py::arg("logHandler").none(false));
  ...
  m.def("openWithAdaptiveCompressionRatio", static_cast<native::VDSHandle(*)(std::string, std::string, float, const native::LogHandler &, native::Error &)>(&OpenWithAdaptiveCompressionRatio), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("waveletAdaptiveRatio").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(OpenWithAdaptiveCompressionRatio_2));
  m.def("openWithAdaptiveCompressionRatio", [](std::string url, std::string connectionString, float waveletAdaptiveRatio, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = OpenWithAdaptiveCompressionRatio(url, connectionString, waveletAdaptiveRatio, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("waveletAdaptiveRatio").none(false), py::arg("logHandler").none(false));
  m.def("open"                        , static_cast<native::VDSHandle(*)(std::string, native::Error &)>(&Open), py::arg("url").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_3));
  ...
  m.def("open"                        , static_cast<native::VDSHandle(*)(std::string, const native::LogHandler &, native::Error &)>(&Open), py::arg("url").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_4));
  m.def("open"                        , [](std::string url, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Open(url, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("logHandler").none(false));
  m.def("open"                        , static_cast<native::VDSHandle(*)(const native::OpenOptions &, native::Error &)>(&Open), py::arg("options").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_5));
  ...
  m.def("open"                        , static_cast<native::VDSHandle(*)(const native::OpenOptions &, const native::LogHandler &, native::Error &)>(&Open), py::arg("options").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_6));
  m.def("open"                        , [](const OpenVDS::OpenOptions & options, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Open(options, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("options").none(false), py::arg("logHandler").none(false));
  m.def("open"                        , static_cast<native::VDSHandle(*)(native::IOManager *, native::Error &)>(&Open), py::arg("ioManager").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_7));
  ...
  m.def("open"                        , static_cast<native::VDSHandle(*)(native::IOManager *, const native::LogHandler &, native::Error &)>(&Open), py::arg("ioManager").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Open_8));
  m.def("open"                        , [](OpenVDS::IOManager * ioManager, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Open(ioManager, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("ioManager").none(false), py::arg("logHandler").none(false));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(std::string, std::string, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::CompressionMethod, float, const native::LogHandler &, native::Error &)>(&Create), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_2));
  m.def("create"                      , [](std::string url, std::string connectionString, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, OpenVDS::CompressionMethod compressionMethod, float compressionTolerance, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(url, connectionString, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, compressionMethod, compressionTolerance, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(std::string, std::string, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, const native::LogHandler &, native::Error &)>(&Create), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_4));
  m.def("create"                      , [](std::string url, std::string connectionString, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(url, connectionString, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("connectionString").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(std::string, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::CompressionMethod, float, const native::LogHandler &, native::Error &)>(&Create), py::arg("url").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_6));
  m.def("create"                      , [](std::string url, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, OpenVDS::CompressionMethod compressionMethod, float compressionTolerance, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(url, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, compressionMethod, compressionTolerance, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false));
  m.def("create"                      , static_cast<native::VDSHandle(*)(std::string, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::Error &)>(&Create), py::arg("url").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_7));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(std::string, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, const native::LogHandler &, native::Error &)>(&Create), py::arg("url").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_8));
  m.def("create"                      , [](std::string url, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(url, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("url").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false));
  m.def("create"                      , static_cast<native::VDSHandle(*)(const native::OpenOptions &, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::CompressionMethod, float, native::Error &)>(&Create), py::arg("options").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_9));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(const native::OpenOptions &, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::CompressionMethod, float, const native::LogHandler &, native::Error &)>(&Create), py::arg("options").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_10));
  m.def("create"                      , [](const OpenVDS::OpenOptions & options, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, OpenVDS::CompressionMethod compressionMethod, float compressionTolerance, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(options, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, compressionMethod, compressionTolerance, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("options").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false));
  m.def("create"                      , static_cast<native::VDSHandle(*)(const native::OpenOptions &, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::Error &)>(&Create), py::arg("options").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_11));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(const native::OpenOptions &, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, const native::LogHandler &, native::Error &)>(&Create), py::arg("options").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_12));
  m.def("create"                      , [](const OpenVDS::OpenOptions & options, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(options, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("options").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false));
  m.def("create"                      , static_cast<native::VDSHandle(*)(native::IOManager *, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::CompressionMethod, float, native::Error &)>(&Create), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_13));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(native::IOManager *, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::CompressionMethod, float, const native::LogHandler &, native::Error &)>(&Create), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_14));
  m.def("create"                      , [](OpenVDS::IOManager * ioManager, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, OpenVDS::CompressionMethod compressionMethod, float compressionTolerance, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(ioManager, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, compressionMethod, compressionTolerance, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("compressionMethod").none(false), py::arg("compressionTolerance").none(false), py::arg("logHandler").none(false));
  m.def("create"                      , static_cast<native::VDSHandle(*)(native::IOManager *, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, native::Error &)>(&Create), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_15));
  ...
  m.def("create"                      , static_cast<native::VDSHandle(*)(native::IOManager *, const native::VolumeDataLayoutDescriptor &, std::vector<VolumeDataAxisDescriptor>, std::vector<VolumeDataChannelDescriptor>, const native::MetadataReadAccess &, const native::LogHandler &, native::Error &)>(&Create), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false), py::arg("error").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(Create_16));
  m.def("create"                      , [](OpenVDS::IOManager * ioManager, const OpenVDS::VolumeDataLayoutDescriptor & layoutDescriptor, std::vector<VolumeDataAxisDescriptor> axisDescriptors, std::vector<VolumeDataChannelDescriptor> channelDescriptors, const OpenVDS::MetadataReadAccess & metadata, const OpenVDS::LogHandler & logHandler) { native::Error err; auto ret = Create(ioManager, layoutDescriptor, axisDescriptors, channelDescriptors, metadata, logHandler, err); if (err.code) { throw std::runtime_error(err.string); } return ret; }, py::call_guard<py::gil_scoped_release>(), py::arg("ioManager").none(false), py::arg("layoutDescriptor").none(false), py::arg("axisDescriptors").none(false), py::arg("channelDescriptors").none(false), py::arg("metadata").none(false), py::arg("logHandler").none(false));
