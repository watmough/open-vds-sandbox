...
//AUTOGEN-BEGIN
  ...
  KnownMetadata_.def_static("categoryStatistics"          , static_cast<const char *(*)()>(&KnownMetadata::CategoryStatistics), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(KnownMetadata_CategoryStatistics));
  KnownMetadata_.def_static("actualValueRange"            , static_cast<native::MetadataKey(*)()>(&KnownMetadata::ActualValueRange), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(KnownMetadata_ActualValueRange));
  KnownMetadata_.def_static("histogram"                   , static_cast<native::MetadataKey(*)()>(&KnownMetadata::Histogram), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(KnownMetadata_Histogram));
