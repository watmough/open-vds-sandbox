...
//AUTOGEN-BEGIN
  ...
  VolumeDataAxisDescriptor_.def("sampleIndexToCoordinate"     , static_cast<float(VolumeDataAxisDescriptor::*)(int) const>(&VolumeDataAxisDescriptor::SampleIndexToCoordinate), py::arg("sampleIndex").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(VolumeDataAxisDescriptor_SampleIndexToCoordinate));
  VolumeDataAxisDescriptor_.def("coordinateToSampleIndex"     , static_cast<int(VolumeDataAxisDescriptor::*)(float) const>(&VolumeDataAxisDescriptor::CoordinateToSampleIndex), py::arg("coordinate").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(VolumeDataAxisDescriptor_CoordinateToSampleIndex));
  VolumeDataAxisDescriptor_.def("coordinateToSamplePosition"  , static_cast<float(VolumeDataAxisDescriptor::*)(float) const>(&VolumeDataAxisDescriptor::CoordinateToSamplePosition), py::arg("coordinate").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(VolumeDataAxisDescriptor_CoordinateToSamplePosition));
