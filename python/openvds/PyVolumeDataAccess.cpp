...
//AUTOGEN-BEGIN
  ...
  VolumeDataPageAccessor_.def("getChunkVolumeDataHash"      , static_cast<int64_t(VolumeDataPageAccessor::*)(int64_t) const>(&VolumeDataPageAccessor::GetChunkVolumeDataHash), py::arg("chunkIndex").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(VolumeDataPageAccessor_GetChunkVolumeDataHash));
