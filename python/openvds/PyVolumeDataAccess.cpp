...
//AUTOGEN-BEGIN
  ...
  VolumeDataPageAccessor_.def("copyPage"                    , static_cast<void(VolumeDataPageAccessor::*)(int64_t, native::VolumeDataPageAccessor &)>(&VolumeDataPageAccessor::CopyPage), py::arg("chunkIndex").none(false), py::arg("source").none(false), py::call_guard<py::gil_scoped_release>(), OPENVDS_DOCSTRING(VolumeDataPageAccessor_CopyPage));
